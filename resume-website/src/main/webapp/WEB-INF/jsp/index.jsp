...
<c:set var="baseURL" value="http://www.eduacsp.com${req.contextPath}" />
...
<head>
    ...
    <meta name="description" content="Software Engineer resume freelance development">
    <meta name="author" content="Developer's name">    
...
<body>
    <div class="wrapper">
        ...
        <div style="position:relative;right:-75%;margin-top:-2%;width:30%;height:62px;">
