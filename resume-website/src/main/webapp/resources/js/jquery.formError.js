      ...
      function( message, options)
      {
         ...
         function remove( options)
         {
            ...
            if( options.successImage.enabled)
            {
               ...
               {
                  var img = $( "<img class='successImage' style='position:absolute; right:-20px; top:3px; z-index:9999;' src='resources/img/" + options.successImage.src + "' />");
            ...
            var errorDiv =
               $("<div class='validationErrorContainer' style='position:absolute; left:101%; top:-2px; z-index:99999;'>" +
                   "<canvas width='14' height='14' style='position:absolute; left:-3px; top:7px;' />" +
                      "<div class='validationError' style='border:1px solid #811; border-radius:5px; padding:10px; background-color:#ff8080; color:white; position:relative; left:10px; white-space:nowrap;'>" +
                     options.message +
                   "</div>" +
                 "</div>");
